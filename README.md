...
```bash
wget -O - https://raw.githubusercontent.com/lacreta/MartinLocaBot/main/install.sh | bash
```
...
```bash
git clone https://github.com/lacreta/MartinLocaBot.git && cd MartinLocaBot
```
