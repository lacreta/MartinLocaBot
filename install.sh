...
if wget -q https://github.com/lacreta/MartinLocaBot/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/lacreta/MartinLocaBot\ncd MartinLocaBot\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/lacreta/MartinLocaBot.git
...
echo -e "npm install google-tts-api"
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} MartinLocaBot${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando MartinLocaBot!!\n\033[0m"
npm start
